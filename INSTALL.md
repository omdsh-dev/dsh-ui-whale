...
> **版本选择**：`v0.3.3`（默认，含睡觉动画）面向 DSH 快照 snapshot0810（`snapshots/20260810T155924Z-8ec407cd64`）；`v0.3.2`（含睡觉动画）面向 snapshot0806（`snapshots/20260806T160212Z-279244acb0`）；`v0.2.0` 同为 0806 构建（无睡觉动画）；`v0.1.0` 面向 snapshot0805（`snapshots/20260805T134133Z-ce1fc03f95`），按旧方式安装。以上构建同时兼容 snapshot0807（`snapshots/20260807T130646Z-e8a0f1a758`）、snapshot0808（`snapshots/20260808T121140Z-7f25d3e98c`）与 snapshot0809（`snapshots/20260809T140917Z-a6bb5a95ba`）——0807~0809 用户直接安装默认版本即可。版本对应详见 [README.md](README.md#版本对应--version-compatibility)。
