window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/mnt/e/deepseek-harness/dsh-ui-whale/src/client/WhalePet.module.css.mjs
		const css = ".KDaNja_pet{--whale-c1:#203864;--whale-c2:#06f;--whale-c3:#b4c7e7;--whale-c4:#f2f2f2;--whale-c5:#c39;--whale-scale:2;width:calc(40px * var(--whale-scale));height:calc(25px * var(--whale-scale));cursor:pointer;flex:none;position:relative}.KDaNja_pixels{width:1px;height:1px;box-shadow:var(--whale-shadows);transform:scale(var(--whale-scale));transform-origin:0 0;position:absolute;top:0;left:0}@media (prefers-reduced-motion:reduce){.KDaNja_pet{--whale-scale:2}}";
