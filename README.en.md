...
> Pinning the tag for git dependencies: `pnpm add '@dsh-external/dsh-ui-whale@github:lhh010/dsh-ui-whale#v0.3.3'` (for 0810/0811 users; 0806~0809 users use `#v0.3.2`, 0805 users use `#v0.1.0`).
