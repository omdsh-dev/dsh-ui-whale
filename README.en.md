...
> - DSH **0.1.1-rc.2** (npm latest): install the **old** version `'@dsh-external/dsh-ui-whale@github:dsh-external/dsh-ui-whale#v0.3.4'`
> - DSH **0.1.2-alpha.1 / alpha.2 / alpha.3**: install the **new** version (the default command below)
## Install

```sh
# Option 1: pinned-tag git dependency (public mirror, recommended; github:dsh-external/dsh-ui-whale also works)
dsh plugin --profile web add '@dsh-external/dsh-ui-whale@github:dsh-external/dsh-ui-whale#v0.3.10'
...
> 1. Run `dsh plugin --profile web add '@dsh-external/dsh-ui-whale@github:dsh-external/dsh-ui-whale#v0.3.10'` (the first run may fail because pnpm 11 blocks node-pty build scripts)
...
> On errors, first check the FAQ/known limitations in the README at <https://github.com/dsh-external/dsh-ui-whale>.
...
> Pinning the tag for git dependencies (public mirror, recommended): `pnpm add '@dsh-external/dsh-ui-whale@github:dsh-external/dsh-ui-whale#v0.3.10'` (or `github:dsh-external/dsh-ui-whale`; historical: 0810/0811 users use `#v0.3.3`, 0806~0809 users `#v0.3.2`, 0805 users `#v0.1.0`).
